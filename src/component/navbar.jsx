      ...
      <div className=" border-b-2 shadow-md border-gray-100 pb-5">
        <div className="max-w-7xl mx-auto my-5 px-4 sm:px-6 ">
          <div className="flex flex-col-reverse md:flex-row min-w-full py-6 space-y-8 justify-center md:justify-between  md:space-x-10">
            <input
              id="search"
              className="flex  leading-none focus:outline-none  border-b-2 hover:border-b-3 border-red-800  w-5/6 mt-12 mx-auto md:w-1/4 md:mt-0 md:mx-0 "
              type="text"
              placeholder=" Find Something ..."
            />
            <a className="flex-1 md:self-start" href="/MarketPlace_AisModa/">
              <div className="flex justify-center ">
                <div className="flex justify-center items-center">
                  <span className=" pt-1 mx-3 whitespace-nowrap text-4xl italic font-light text-sky-500 ">
                    Sejuta
                    <span className="whitespace-nowrap text-4xl italic font-light text-yellow-500 ">
                      Cita
                    </span>
                  </span>
                </div>
        ...
        <nav id="bar" className="flex justify-center">
          <div className="hidden md:flex md:flex-row justify-center md:space-y-0 my-4 space-y-4  text-center text-gray-500">
